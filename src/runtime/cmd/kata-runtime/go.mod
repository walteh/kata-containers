module github.com/kata-containers/kata-containers/src/runtime/cmd-kata-runtime
...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20250502103140-fbf7faa9f47e
